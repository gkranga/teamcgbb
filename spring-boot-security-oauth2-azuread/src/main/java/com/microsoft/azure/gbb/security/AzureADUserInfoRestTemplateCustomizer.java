...
public class AzureADUserInfoRestTemplateCustomizer implements UserInfoRestTemplateCustomizer {
    ...
    public void customize(OAuth2RestTemplate oAuth2RestTemplate) {
        ...
        oAuth2RestTemplate.setAuthenticator(new AzureADOauth2RequestAuthenticator());

        // Attempt 1: Use my own token provider, but it never gets called...
        oAuth2RestTemplate.setAccessTokenProvider(new AzureADAccessTokenProvider());
